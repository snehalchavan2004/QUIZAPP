...
public class cplus extends AppCompatActivity {
    ...
    queandansadapter[] questionbank = new queandansadapter[]{
            new queandansadapter(R.string.QUESTION_11, true),
            new queandansadapter(R.string.QUESTION_12, false),
            new queandansadapter(R.string.QUESTION_13, true),
            new queandansadapter(R.string.QUESTION_14, false),
            new queandansadapter(R.string.QUESTION_15, true),
            new queandansadapter(R.string.QUESTION_16, false),
            new queandansadapter(R.string.QUESTION_17, true),
            new queandansadapter(R.string.QUESTION_18, true),
            new queandansadapter(R.string.QUESTION_19, false),
            new queandansadapter(R.string.QUESTION_20, true)};
